...
`PublicContact` defines public-source contact records with explicit confidence and contact type. A person may be labeled `HIRING_MANAGER` only when verified; no authenticated LinkedIn scraping is permitted.

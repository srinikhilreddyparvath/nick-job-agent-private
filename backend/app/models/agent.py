...
class AgentRunRead(BaseModel):
    ...
    provider:str|None=None; model:str|None=None; prompt_version:str|None=None; temperature:float|None=None; evidence_ids_used:list[str]=Field(default_factory=list); sources_used:list[str]=Field(default_factory=list); input_tokens:int=0; output_tokens:int=0; estimated_cost:float=0; latency_ms:int=0
